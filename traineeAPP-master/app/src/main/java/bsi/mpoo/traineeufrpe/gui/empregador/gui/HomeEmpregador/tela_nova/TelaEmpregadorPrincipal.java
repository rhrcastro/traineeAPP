...
import bsi.mpoo.traineeufrpe.gui.empregador.gui.CadastrarVaga;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent TelaVaga = new Intent(TelaEmpregadorPrincipal.this, CadastrarVaga.class);
                startActivity(TelaVaga);
            }
        });
        ...
        ImageView foto = headView.findViewById(R.id.imagemEmpregadorDrawer);
