...
import com.trainee2.extras.MyFragmentPagerAdapterTEP;
...
public class TelaPrincipalEstagiario extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mViewPager.setAdapter(new MyFragmentPagerAdapterTEP(getSupportFragmentManager(), getResources().getStringArray(R.array.tabsPrincipal)));
        ...
        TextView nome = headView.findViewById(R.id.nomeUsuarioDrawer);
        TextView email = headView.findViewById(R.id.emailUsuarioDrawer);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.tela_principal_estagiario, menu);
        return true;
    }
